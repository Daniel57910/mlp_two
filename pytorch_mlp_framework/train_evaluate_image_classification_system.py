...
from pytorch_mlp_framework.model_architectures_dm import (
        ConvolutionalProcessingBlockDM, ConvolutionalReductionBlockDM
)
import os 
...
experiment_metrics, test_metrics, grad_plot = conv_experiment.run_experiment()  # run experiment and return experiment metrics